...
/**
  useStageGetContactInfo is a hook that will add this stage to the state machine. It is responsible for:
        ...
        return (
          <ContactInfo
            ...
            onSubmit={(name, email, phone) => {
              ...
              // This moves the state machine to the next stage, buildCar deterministically.
              setStage("buildCar");
            }}
          />
        );
